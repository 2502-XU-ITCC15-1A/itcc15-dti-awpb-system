          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-xl border bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p>
                  <span className="font-medium">Unit:</span> {entry.unit || "N/A"}
                </p>
                <p>
                ...
                <p>
                  ...
                  {entry.subComponent || "N/A"}
                </p>
                <p>
                  <span className="font-medium">Key Activity:</span>{" "}
                  {entry.keyActivity || "N/A"}
                </p>
                <p>
                  <span className="font-medium">No.:</span> {entry.no || "N/A"}
                </p>
                <p>
                  <span className="font-medium">Performance Indicator:</span>{" "}
                  {entry.performanceIndicator || "N/A"}
                </p>
                <p>
                  <span className="font-medium">Sub Activity:</span>{" "}
                  {entry.subActivity || "N/A"}
                </p>
              </div>
            </div>
